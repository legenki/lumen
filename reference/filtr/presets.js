...
// (bundle-pretty.js:42094-46719, anchor: `"User Preset": "userPreset"` at
// bundle-pretty.js:42092 marks the displayName->var map this order follows).
// !0/!1 -> true/false is the only transformation applied; all other values,
// including scientific-notation float literals (e.g. 5e-33), are verbatim.
// The 28 built-in presets below exclude "User Preset", which is a runtime
// slot for user-saved presets, not shipped preset data.
