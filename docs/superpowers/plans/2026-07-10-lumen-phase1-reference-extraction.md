...
- [x] **Step 1: Создать манифест ассетов**
...
- [x] **Step 2: Написать скрипт скачивания** `reference/filtr/tools/download-live.sh`:
...
- [x] **Step 3: Запустить и проверить**
...
- [x] **Step 1: Прогнать js-beautify (пиновая версия)**
...
- [x] **Step 1: Скопировать frag-файлы, убрав хэши из имён**
...
- [x] **Step 2: Проверить целостность**
...
- [x] **Step 3: Задокументировать вершинный шейдер и загрузку**
...
- [x] **Step 1: Написать проверочный скрипт (сначала — он)** `reference/filtr/tools/verify-modules.mjs`:
...
- [x] **Step 1: Написать проверочный скрипт** `reference/filtr/tools/verify-presets.mjs`:
...
- [x] **Step 1: Исследовать бандл по якорям и записать заметки**
...
- [x] **Step 1: Написать README** со следующим содержанием (дословно, дополнив фактами из Task 3/6):
...
- [x] **Step 2: Прогнать обе проверки ещё раз (регресс всего каталога)**
